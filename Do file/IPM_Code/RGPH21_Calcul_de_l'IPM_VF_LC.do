...
mpi d1(desco educ mfsa) w1(0.066 0.066 0.066) d2(chom) w2(0.2) d3(paselec paseaup combsale  pasta logement pasequi) w3( 0.033 0.033 0.033 0.033 0.033 0.033)d4(mjuv) w4(0.2) d5(Ident) w5(0.2) [fw=TOTMEN],cutoff(0.3333) by(VILLAGE)
...
mat A_reg_`code_region'  = H_Lc,M_Lc,Indicateur_reg, vulnerable,sev_pauvre, pop, poor[1..$nblc,1]

*decode I04_SOUSPREF,gen(SP)
levelsof VILLAGE if si!=.,local(LC)
mat rownames A_reg_`code_region' = `LC'
