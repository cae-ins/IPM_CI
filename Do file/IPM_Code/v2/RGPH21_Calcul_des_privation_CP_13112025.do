...
global do "C:\CAE_IPM\Do file"
global out "C:\CAE_IPM\Sortie"
use "$in\IPM_Data_131124.dta", clear
...
keep $list_var_menage EW P06 desco educ mfsa  chom P16  Ident  paselec paseaup paselec paseaup combsale pasta solterre toiture matmur logement pasequi TAILLE_MENAGE 
...
merge m:1 $list_var_menage using "$out\DECES8_RGPH2021.dta" ,keepusing(decs18)
