...
****CHEMIN****
global data "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2021\Bases brutes" 	  
global sortie "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2021\Sortie"
global dofile "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2021\Do file"
...
merge  m : 1 "$sortie\data_results_nf.dta"

********************************************************************************
*********************DIMENSION SANTE************************
********************************************************************************
import spss using "$data\MORTALITE_RP2021_TRAITEMENT.sav", clear
...
use "$sortie\data_results_nf.dta"

merge m:1 $list_var_menage using "$sortie\DECES8_RGPH2021.dta" ,keepusing(decs18)

gen mjuv = decs18 > 0
*Le nombre de décès n'est pas dans la base de données des individus
