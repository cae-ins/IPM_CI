...
use "$in\IPM_Data_120924.dta", clear
...
keep $list_var_menage P06 desco educ mfsa  chom P16  Ident educ1 paselec paseaup paselec paseaup combsale pasta solterre toiture matmur logement pasequi TAILLE_MENAGE 

save "$out\bf.dta", replace
