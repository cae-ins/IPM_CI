...
tab no_missing_edu, miss
	//Check that values for 0 are less than 1%: 0.28%.
...
lab var hh_years_edu_u "Household has at least one member with 10 year of edu"
 ...
 */ 
tab hv105 eduyears if hv105>=17
by hh_id, sort: gen literacy= (eduyears>=8 & hv105 >=17)
lab var literacy "A household member aged 17 or over does not know how to read or write (French); 1=yes, 0=no"
...
label var childu18_mortality_5y "Under 18 child mortality within household past 1 year reported by women"
tab childu18_mortality_5y, miss		
...
*** National MPI ***
gen	water_mdg_1     = 1 if water<=31 | water==41 | water==71  	
replace water_mdg = 0 if water==32 | water==42 | water==43 | ///
						 water==61 | water==62 | water==96 
lab var water_mdg "Household has drinking water"
...
egen n_small_assetsN = rowtotal(aircond television radio telephone refrigerator bicycle motorbike computer internet ), missing
...
replace hv140=0 if hv140==8
gen Identification = inlist(hv140,1,2)
lab var Identification "Household has a child who has a birth certificate or is declared"
...
n_small_assets2 hh_assets2 hh_assets2_u windex windexf  Identification ///
literacy mveh internet boat aircond hh_mortality_u18_1y hh_years_edu_10 ///
water_mdg_1 hh_assetsN Identification hv001 hv002 hv105  hv121
...
recode literacy				(0=1)(1=0) , gen(d_lit)
recode electricity 			(0=1)(1=0) , gen(d_elct)
recode water_mdg 			(0=1)(1=0) , gen(d_wtr)
recode water_mdg_1			(0=1)(1=0) , gen(d_wtr1)
...
********************************************************************************
*** Step 2.12 Employment***
********************************************************************************

use "$data/CIIR62FL.dta", clear
keep caseid v714a v714 v716 v717 v719 v721 v002 v001
save "$sortie/emplfem.dta", replace
use "$data/CIMR62FL.dta", clear 
keep mcaseid mv714a mv714 mv716 mv717 mv719 mv721 mv002 mv001
ren mcaseid hh_id
ren mv714 v714
ren mv714a v714a
ren mv716 V716
...
ren mv719 v719
ren mv721 v721
append using "$sortie/emplfem.dta"
...
****Merging
use "$sortie\base_travail_EDS12"
merge m:m hv001 hv002  using "$sortie/employment.dta", force
drop _merge
bysort hh_id : egen hh_employed = sum( employed )
gen empage = ( hv105 >=15 & hv105 <=59)
...
mpi d1(d_educ1 d_satt  d_lit ) w1(0.083 0.083 0.083) d2(d_unemp) w2(0.25) d3(d_elct water_mdg_1 d_sani  d_hsg d_ckfl  d_asst1) w3(0.041 0.041 0.041 0.041 0.041 0.041) d4( d_cm1) w4(0.25) [weight=weight]   , cutoff (0.3333) by (region) 
...
cap drop si vulnerable sev_pauvre poor
mpi d1(d_educ1 d_satt  d_lit ) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.20) d3(d_elct water_mdg_1 d_sani  d_hsg d_ckfl  d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_unempm1) w4(0.20) d5(id) w5(0.20) [weight=weight]  , cutoff(0.3333) by (region) 
