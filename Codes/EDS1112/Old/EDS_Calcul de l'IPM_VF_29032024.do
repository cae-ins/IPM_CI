...
*** Working Folder Path ***
global data "C:\Users\Dell\OneDrive\Bureau\PHAS\IPMC\EDS\Bases brutes" 
global sortie "C:\Users\Dell\OneDrive\Bureau\PHAS\IPMC\EDS\Sortie"
global dofile "C:\Users\Dell\OneDrive\Bureau\PHAS\IPMC\EDS\Do file"
global adoigrowthup "C:\Users\Dell\OneDrive\Bureau\PHAS\IPMC\EDS\Bases brutes\igrowup_update-master"
global adowho "C:\Users\Dell\OneDrive\Bureau\PHAS\IPMC\EDS\Bases brutes\who2007_update"		
********************************************************************************
...
replace toilet_mdg_1 = 1 if !(toilet<23 | toilet==41)   
...
gen literacy= 1 if (v155==1|v155==2|v106==2|v106==3) & (v012>=17 & v012 <= 49)
replace literacy=0 if !(v155==1|v155==2|v106==2|v106==3) & (v012>=17 & v012 <= 49)
bysort hv001 hv002: egen lit= max(literacy) if (v012>=17 & v012 <= 49)
...
egen NBmis3 = rowmiss(d_satt d_educ1 d_lit d_elct d_wtr1 d_ckfl d_sani_1 d_hsg d_asst d_nutr d_unemp Ident)
replace NBmis3 = 1 if NBmis !=0
recode NBmis3 (0=1) (1=0)
rename NBmis3 touse3
egen nbdeprN = rowtotal(d_satt d_educ1 d_lit d_elct d_wtr1 d_ckfl d_sani_1 d_hsg d_asst  d_nutr d_unemp Ident)
...
mpi d1(d_educ1 d_satt  d_lit ) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.20) d3(d_elct d_wtr1 d_sani  d_hsg d_ckfl  d_asst) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight]  , cutoff(0.3333) by (region) 
...
putexcel clear
putexcel set "$sortie\INPM_EDS_1112.xlsx", sheet("REGION_NATIONAL") modify
putexcel save
...
// Vulnerabilté
gen si = (d_educ1 + d_satt + d_lit)*0.066 + d_cm*0.20 + (d_elct + d_wtr1 + d_sani +  d_hsg + d_ckfl + d_asst)*0.033 + d_unemp*0.20 + Ident*0.20
...
putexcel clear
putexcel set  "$sortie\INPM_EDS_1112", sheet("REGION_PNUD") modify
...
drop si vulnerable sev_pauvre poor R
mpi d1(d_educ1 d_satt  d_lit ) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.20) d3(d_elct d_wtr1 d_sani  d_hsg d_ckfl  d_asst) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight]  , cutoff(0.3333) by (area) 
...
// Vulnerabilté
gen si = (d_educ1 + d_satt + d_lit)*0.066 + d_cm1*0.20 + (d_elct + d_wtr1 + d_sani +  d_hsg + d_ckfl + d_asst)*0.033 + d_unemp*0.20 + Ident*0.20
...
/* Exportation sur Excel dans le dossier Resultats_Tab*/
putexcel clear
putexcel set  "$sortie\INPM_EDS_1112", sheet("AREA_NATIONAL") modify
...
/* Exportation sur Excel dans le dossier Resultats_Tab*/
putexcel clear
putexcel set  "$sortie\INPM_EDS_1112", sheet("AREA_PNUD") modify
