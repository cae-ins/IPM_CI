...
global list_var_menage "I04_SOUSPREF I05_COMMUNE I09_MILIEU I06_ZD  I08_QUARCPT I10_ILOT I10A_BATIMEN I10B_LOGEMEN I11N_MENAGE  DEPARTEMEN REGION DISTRICT" 
cd "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2014\Sortie\Decoupage_REGIONRP14"
...
foreach var of local   list_de_fichier{
   do "$dofile\RGPH14_Calcul_de_l'IPM_VF_SP_11032024" `var' `reg'
   local reg = `reg' + 1
}
...
putexcel clear
putexcel set  "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2014\Sortie\IPM-CI_2014", sheet("SOUS-PREFECTURES") modify
...
clear
import excel "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2014\Sortie\IPM-CI_2014", sheet("SOUS-PREFECTURES") firstrow
gen SPID=real(B)
drop A B 
sort SPID
order SPID
export excel using "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\RGPH\RGPH 2014\Sortie\IPM-CI_2014_SP.xlsx", replace sheet("SOUS-PREFECTURES") firstrow(variables)  
