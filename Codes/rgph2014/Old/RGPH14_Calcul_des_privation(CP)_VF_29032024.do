...
gen alphab = 1 if (P28_ALPHABETISATION == 1) | !inlist(niveauinst,1,2,7) & inrange(P19_AGE, 17,49)
replace alphab = 0 if !(P28_ALPHABETISATION == 1) | inlist(niveauinst,1,2,7) & inrange(P19_AGE, 17,49)
by $list_var_menage, sort: egen total_analph = max(alphab)
recode total_analph (0=1) (1=0), gen(mfsa)
replace mfsa=. if niveauinst==7
...
keep $list_var_menage desco educ mfsa mfsa1 chom P17_LIENPARENTE pasid  paselec paseaup  paselec paseaup combsale pasta solterre toiture matmur logement pasequi Ident educ1 DE59_DECES I07_NOMVILLAG I07_CODEVILLAG TOTMEN P28_ALPHABETISATION niveauinst P29_INSTRUCTION
