...
gen malnutrition = (random_number < 0.2)
drop random_number
...
egen NBmis1 = rowmiss(desco educ1 mfsa paselec paseaup combsale  pasta logement pasequi malnutrition)
replace NBmis1 = 1 if NBmis !=0
recode NBmis1 (0=1) (1=0)
rename NBmis1 touse1
lab var touse1 "Household without missing value for MPI indicators - REFERENCE "
egen nbdeprP = rowtotal( desco educ1 mfsa paselec paseaup combsale  pasta logement pasequi malnutrition )
lab var nbdeprP "Number of deprivation Reference"

tabstat nbdeprP if touse1, s(mean sd) col(stat), [fw=TOTMEN]


egen NBmis2 = rowmiss(desco educ1 mfsa paselec paseaup combsale  pasta logement pasequi chom malnutrition mjuv )
replace NBmis2 = 1 if NBmis !=0
recode NBmis2 (0=1) (1=0)
rename NBmis2 touse2
lab var touse2 "Household without missing value for MPI indicators - REFERENCE "
egen nbdeprR = rowtotal( desco educ1 mfsa paselec paseaup combsale  pasta logement pasequi chom malnutrition mjuv)
lab var nbdeprR "Number of deprivation Reference"

tabstat nbdeprR if touse2, s(mean sd) col(stat), [fw=TOTMEN]


egen NBmis3 = rowmiss(desco educ1 mfsa paselec paseaup combsale  pasta logement pasequi chom malnutrition mjuv Ident )
replace NBmis3 = 1 if NBmis !=0
recode NBmis3 (0=1) (1=0)
rename NBmis3 touse3
lab var touse3 "Household without missing value for MPI indicators - REFERENCE "
egen nbdeprN = rowtotal( desco educ1 mfsa paselec paseaup combsale  pasta logement pasequi chom malnutrition mjuv Ident)
lab var nbdeprN "Number of deprivation Reference"
...
putexcel clear
putexcel set  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014", sheet("REGION") modify
...
putexcel clear
putexcel set  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014", sheet("DISTRICT") modify
...
putexcel clear
putexcel set  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014", sheet("MILIEU") modify
...
log using "C:\Users\Dell\OneDrive\Bureau\Departement.log", replace
...
/* Exportation sur Excel dans le dossier Resultats_Tab*/
putexcel clear
putexcel set  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014", sheet("DEPARTEMEN") modify
