...
foreach var of local list_de_fichier {
   do "$dofile\Extraction_par_Localité" `var' `Sp'
   local Sp = `Sp' + 1
}
...
putexcel clear
putexcel set  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014", sheet("LOCALITE") modify
...
clear
import excel "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014.xlsx", sheet("LOCALITE") firstrow
gen LCID=real( A)
drop A
sort LCID
export excel using "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014_LC.xlsx", replace sheet("LOCALITE") firstrow(variables)  

*Il y'a des doublons dans les localités, on les supprime
duplicates report LCID
duplicates drop LCID, force
save "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014_LC.dta"

use  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\VILLAGE",  clear
sort VILLAGE
gen LCID = VILLAGE
keep VILLAGE LCID
...
merge 1:1 LCID using  "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014_LC.dta"
drop if _merge !=3
drop _merge
...
export excel using "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014.xlsx", sheet("LOCALITE", modify) cell(B6) firstrow(variables)
save "C:\Users\Dell\OneDrive\Bureau\PHAS\INPM\RGPH\RGPH 2014\Sortie\INPM_2014_LC.dta", replace


*Note : dans la sp 2911, on supprime les villages mal orthographiés, cela cause un break.
