...
// mpi PNUD
mpi d1(d_satt d_educ) w1(0.17 0.17) d2(d_cm d_nutr) w2(0.17 0.16) d3(d_elct d_wtr d_sani  d_hsg d_ckfl d_asst) w3(0.056 0.0556  0.0556 0.0556  0.0556  0.0556) [weight=psu] ,cutoff(0.3333) by (region) 
...
putexcel clear
putexcel set  "$sortie\INPM_MICS_2016", sheet("PNUD") replace
...
putexcel (B3:M3), bold border(bottom)
putexcel (B4:M4), bold border(bottom)

putexcel (P3:Q3)="POPULATION TOTALE", merge
putexcel (P3:Q3), bold border(bottom)
putexcel (P4:Q4), bold border(bottom)
...
cap drop si vulnerable sev_pauvre poor
mpi d1(d_educ10 d_satt  d_literacy ) w1(0.083 0.083 0.083) d2(d_unemp) w2(0.25) d3(d_elct d_wtr d_sani  d_hsg d_ckfl  d_asst1) w3(0.041 0.041 0.041 0.041 0.041 0.041) d4( d_cm1) w4(0.25) [weight=psu], cutoff (0.3333) by (region) 
...
/* Exportation sur Excel dans le dossier Resultats_Tab*/
putexcel clear
putexcel set  "$sortie\INPM_MICS_2016", sheet("Année de référence 1998") modify
...
putexcel (B3:N3), bold border(bottom)
putexcel (B4:N4), bold border(bottom)

putexcel (O3:R3)="POPULATION & VULNERABILITE", merge
putexcel (O3:R3), bold border(bottom)
...
mpi d1(d_educ10 d_satt  d_literacy ) w1(0.066 0.066 0.066) d2(d_unemp) w2(0.20) d3(d_elct d_wtr d_sani  d_hsg d_ckfl  d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_cm1) w4(0.20) w5(id) w5(0.20) [weight=psu], cutoff(0.3333) by (region) 
...
/* Exportation sur Excel dans le dossier Resultats_Tab*/
putexcel clear
putexcel set  "$sortie\INPM_MICS_2016", sheet("Proposition Nationale") modify
