...
global data "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes" 	  
global sortie "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Sortie"
global dofile "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS\MICS 2016\Dofile"
global adoigrowthup "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes\igrowup_update-master"
global adowho "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes\who2007_update"		
...
adopath + "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes\who2007_update"


/* We use 'reflib' to specify the package directory where the .dta files 
containing the WHO Growth reference are stored. Note that we use strX to specify 
the length of the path in string. */		
gen str100 reflib = "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes\who2007_update"
lab var reflib "Directory of reference tables"
...
gen str100 datalib = "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes\who2007_update" 
lab var datalib "Directory for datafiles"
...
use "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Bases brutes\who2007_update\girl_nutri_civ_z.dta", clear 
...
save "$sortie/CIV16_WM_girls.dta", replace
	...
	//Erase files from folder:
*erase "C:\Users\Dell\OneDrive\Bureau\PHAS\IPMC\MICS 2016\ Bases brutes \who2007_update//girl_nutri_civ_z.xls"
...
*** Standard MPI ***
gen	toilet_mdg_1    = .
replace toilet_mdg_1 = (toilet<23 | toilet==31)  
...
foreach var in television radio telephone refrigerator ///
			   car bicycle motorbike computer animal_cart aircond internet boat  {
...
*** National MPI ***
/*The household has at most 1 equipment from the following list: air 
...
codebook mwb7
codebook mwb4
ta mwb7 if mwb2>=17 & mwb2 <= 49,m
tab mwb4 mwb7 if mwb2>=17 & mwb2 <= 49, m
gen double ind_id = hh1 *100000 + hh2 *100 + ln
keep hh1 hh2 ln  mls5 dpH mwb7 mwb2 mwb4 mls7 mls5 
gen literacy= 1 if (mwb7==2 | mwb7==3 | mwb4==2 | mwb4==3) & (mwb2>=15 & mwb2 <= 49)
replace literacy=0 if !(mwb7==2 | mwb7==3 | mwb4==2 | mwb4==3) & (mwb2>=15 & mwb2 <= 49)
*replace literacy=. if mwb7 ==.
...
bysort hh1 hh2: egen lit= max(literacy) 
gen cas1 = mwb2>=15 & mwb2 <= 49
bysort hh1 hh2: egen cas= total(cas1)
drop cas1
...
egen NBmis3 = rowmiss(d_satt d_educ1 d_lit d_elct d_wtrN d_ckfl d_sani_1 d_hsg d_asst1 d_cm1 d_unemp Ident)
replace NBmis3 = 1 if NBmis !=0
recode NBmis3 (0=1) (1=0)
rename NBmis3 touse3
egen nbdeprN = rowtotal(d_satt d_educ1 d_lit d_elct d_wtrN d_ckfl d_sani_1 d_hsg d_asst1 d_cm1 d_unemp Ident)
...
global nb_zone = 11
 mpi d1(d_educ1 d_satt  d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.20) d3(d_elct d_wtrN d_sani_1  d_hsg d_ckfl  d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight] , cutoff(0.3333) by (region) 
...
// Vulnérabilté
gen si = (d_educ1 + d_satt + d_lit)*0.066 + d_cm1*0.20 + (d_elct + d_wtrN + d_sani_1 +  d_hsg + d_ckfl + d_asst1)*0.033 + d_unemp*0.20 + Ident*0.20
...
putexcel clear
putexcel set  "$sortie\IPM-CI_MICS_2016", sheet("REGION_NATIONAL") modify
...
/* Exportation sur Excel*/
putexcel clear
putexcel set  "$sortie\IPM-CI_MICS_2016.xlsx", sheet("REGION_PNUD") modify
...
putexcel clear
putexcel set  "$sortie\IPM-CI_MICS_2016.xlsx", sheet("MILLIEU_PNUD") modify
...
mpi d1(d_educ1 d_satt  d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.20) d3(d_elct d_wtrN d_sani_1  d_hsg d_ckfl  d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.3333) by (area) 
* M0 et H
mat A = e(by_mpi)
mat list A
mat define A=e(by_mpi)'
...
/* Exportation sur Excel */
putexcel clear
putexcel set  "$sortie\IPM-CI_MICS_2016.xlsx", sheet("MILIEU_NATIONAL") modify
