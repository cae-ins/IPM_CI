...
gen literacy= !inlist(mwb7,3) & (mwb2>=17)
...
keep hh1 hh2 ln  mls5 dpH mwb7 mwb2 lit
...
codebook wb7
ta wb7 if wb2>=17,m
gen literacy= !inlist(wb7,3) & (wb2>=17)
bysort hh1 hh2 : egen lit= max(literacy)
lab var lit "A household member aged 17 or over does not know how to read (French); 1=yes, 0=no)"
*replace lit=. if wb7==.
keep hh1 hh2 ln ls5 ndpH wb7 wb2 lit
ren wb7 mwb7
ren wb2 mwb2
ren ls5 mls5
...
keep hh1 hh2 d_unemp lit ind_id
save "$sortie\Unemployment&Literacy.dta", replace

use "$sortie\base_travail_mics2016.dta"
merge 1:1 ind_id using "$sortie\Unemployment&Literacy.dta",
rename lit d_lit
save "$sortie\base_travail_mics2016.dta", replace
...
d_cm d_cm1 d_nutr d_satt d_educ d_educ10 d_literacy d_elct d_wtr d_sani d_hsg d_ckfl d_asst d_unemp Identification water_mdgN


order hh_id ind_id psu strata subsample weight ///
area region region_01 agec4 agec2 headship ///
d_cm d_cm1 d_nutr d_satt d_educ d_educ10 d_elct d_wtr d_sani d_hsg d_ckfl d_asst d_asst1 d_literacy d_unemp Ident
*/
...
egen NBmis3 = rowmiss(d_satt d_educ1 d_lit d_elct d_wtrN d_ckfl d_sani d_hsg d_asst d_cm1 d_nutr d_unemp Ident)
replace NBmis3 = 1 if NBmis !=0
recode NBmis3 (0=1) (1=0)
rename NBmis3 touse3
egen nbdeprN = rowtotal(d_satt d_educ1 d_lit d_elct d_wtrN d_ckfl d_sani d_hsg d_asst d_cm1 d_nutr d_unemp Ident)
...
cap drop si vulnerable sev_pauvre poor
mpi d1(d_educ1 d_satt  d_lit ) w1(0.066 0.066 0.066) d2(d_unemp) w2(0.20) d3(d_elct d_wtrN d_sani  d_hsg d_ckfl  d_asst) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_cm1) w4(0.20) d5(Ident) w5(0.20) [pweight=weight]  , cutoff(0.3333) by (region) 
...
cap drop si vulnerable sev_pauvre poor
mpi d1(d_educ d_satt  d_lit ) w1(0.066 0.066 0.066) d2(d_unemp) w2(0.20) d3(d_elct d_wtr d_sani  d_hsg d_ckfl  d_asst) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_cm) w4(0.20) d5(Ident) w5(0.20) [pweight=weight]  , cutoff(0.3333) by (region) 
...
cap drop si vulnerable sev_pauvre poor AR
mpi d1(d_educ10 d_satt  d_literacy ) w1(0.083 0.083 0.083) d2(d_cm1) w2(0.25) d3(d_elct d_wtr_mdg d_sani  d_hsg d_ckfl  d_asst1) w3(0.041 0.041 0.041 0.041 0.041 0.041) d4( d_unemp) w4(0.25) [weight=weight], cutoff (0.3333) by (area) 
...
mpi d1(d_educ10 d_satt  d_literacy ) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.20) d3(d_elct d_wtr_mdg d_sani  d_hsg d_ckfl  d_asst) w3(0.033 0.033 0.033 0.033 0.033 0.033) d4( d_unemp) w4(0.20) d5(ident) w5(0.20) [pweight=weight], cutoff(0.3333) by (area) 
* M0 et H
mat A = e(by_mpi)
mat list A
mat define A=e(by_mpi)'
