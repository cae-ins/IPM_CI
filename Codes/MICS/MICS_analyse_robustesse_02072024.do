...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.13) by(region)
matrix A = e(by_mpi)
mat define A = A'
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.23) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.33) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.43) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.53) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.63) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.73) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.83) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
mpi d1(d_educ10 d_satt d_lit) w1(0.066 0.066 0.066) d2(d_cm1) w2(0.2) ///
    d3(d_elct d_wtrN d_sani_1 d_hsg d_ckfl d_asst1) w3(0.033 0.033 0.033 0.033 0.033 0.033) ///
    d4(d_unemp) w4(0.20) d5(Ident) w5(0.20) [pweight=weight], cutoff(0.93) by(region)
matrix A = e(by_mpi)
mat define A = A'
submatrix A, rownum(1/11)
...
import excel "C:\Users\Dell\OneDrive\Bureau\PHAS\IPM-CI\MICS 2016\Sortie\IPM-CI_robustness.xlsx", sheet("k=alpha") firstrow clear
