...
main-d'\oe uvre (SU1 à SU4) et le NEET. Elle chiffre chacune sur l'EHCVM et conclut sur les
arbitrages ouverts.
\end{abstract}
...
\begin{enumerate}
  \item \textbf{Remplacer SU1 par SU3 dans l'indicateur de chômage.} Le périmètre passerait de
  561 à 1\,219 personnes concernées sur la bande 17-40, et l'effet sur l'indicateur ménage
  « au moins un » sera mécaniquement plus fort encore. C'est la piste la plus directe pour rendre
  à la dimension un équilibre entre ses deux jambes.
