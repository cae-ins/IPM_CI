...
\midrule
Pauvre monétaire & 26,2~\% & 4,2~\% \\
Non pauvre monétaire & 31,7~\% & 37,8~\% \\
\bottomrule
\end{tabular}
\end{center}

La lecture est nette : \textbf{86~\% des pauvres monétaires sont aussi pauvres au sens
multidimensionnel}, mais \textbf{31,7 points de population sont privés sans être pauvres
monétairement}. Autrement dit, une politique qui ne suivrait que le revenu manquerait près d'un
tiers de la population que le PND entend servir.

\begin{attention}[Un calcul à consolider avant publication]
Le croisement ci-dessus applique directement le seuil de pauvreté national (\col{zref}) à la
dépense par tête (\col{pcexp}) de la base ménage. Il donne un taux de pauvreté monétaire de
30,5~\%, contre les \textbf{37,5~\%} publiés et repris par le PND. L'écart tient vraisemblablement
aux déflateurs spatiaux et temporels appliqués par l'INS, qui ne sont pas dans la base.

La \emph{structure} du croisement --- un recouvrement fort mais partiel, une pauvreté
multidimensionnelle bien plus large que la monétaire --- est robuste à cet écart. Les
\emph{niveaux} des quatre cases ne doivent pas être publiés tels quels sans que la méthode
officielle de calcul du taux monétaire ait été reprise.
\end{attention}
...
\begin{enumerate}
  ...
  \item \textbf{Le croisement monétaire / multidimensionnel} n'est pas reproduit sur la méthode
        officielle de calcul du taux de pauvreté monétaire.
