...
\begin{itemize}
  \item L'avantage de l'EHCVM sur le recensement tient à \textbf{trois indicateurs}, et deux
        d'entre eux sont des indicateurs de santé : l'assurance maladie, le renoncement aux soins,
        et l'année de scolarité mesurée exactement plutôt qu'approchée par le diplôme.
  \item Il est \textbf{le seul} à donner prise aux cibles santé et nutrition du Pilier 4 ---
        Couverture Maladie Universelle, protection sociale, accès effectif aux soins --- auxquelles
        le recensement n'en donne aucune, faute de tout module de santé.
  \item Il est \textbf{le seul} à porter la pauvreté monétaire et la pauvreté multidimensionnelle
        ...
        besoin.
  \item Étant une \textbf{enquête répétée}, il peut être recalculé en cours de plan, là où le
        recensement, décennal, ne le pourra pas.
...
\begin{retenir}[Le décompte, et ce qu'il ne dit pas]
...
Ce décompte est à manier avec prudence : il compte des \emph{cibles}, et plusieurs cibles
retombent sur le \emph{même} indicateur --- les deux cibles d'analphabétisme comme les deux cibles
de couverture sociale. En indicateurs distincts à prise directe, le compte tombe à \textbf{neuf}.

Il favorise en outre mécaniquement la source qui porte le plus d'indicateurs : l'EHCVM en a seize,
le RGPH treize. Ce n'est pas un résultat, c'est une propriété du questionnaire.
\end{retenir}
...
Le \textbf{sexe du chef de ménage} est disponible dans l'EHCVM et permet de désagréger l'indice
par sexe --- ce que le recensement, dans l'extrait transmis, ne permet pas.

\begin{attention}[Ne pas surestimer cet avantage]
Deux réserves. D'abord, désagréger l'IPM par sexe du chef de ménage ne \emph{mesure} pas la cible
« indice de l'écart genre 0,655 $\to$ 0,7 » : cet indice est un composite couvrant l'emploi,
l'éducation, la santé et la représentation politique. C'est un éclairage, pas une mesure.

Ensuite, l'absence du sexe au RGPH est un fait de \textbf{transmission, non de collecte} : la
numérotation des questions de l'extrait passe de P16 à P18, la question P17 manquant --- c'est
très probablement le sexe. Une demande à l'INS lèverait cette limite du côté du recensement.
\end{attention}

L'apport réellement propre à l'EHCVM est ailleurs : elle porte dans la même base la \textbf{consommation des ménages} : c'est elle qui
...
l'EHCVM est une \textbf{enquête répétée} : elle existe pour 2018 et pour 2021.

\begin{attention}[Ce qui est établi, et ce qui ne l'est pas]
Ce qui est certain : le RGPH est \textbf{décennal}, le prochain n'interviendra pas avant la fin du
plan, et le recensement ne pourra donc mesurer aucun progrès du PND.

Ce qui ne l'est pas : le calendrier de la prochaine vague d'EHCVM. Le rythme passé (2018, puis
2021) le laisse attendre dans l'intervalle du plan, mais \textbf{aucune programmation n'a été
vérifiée ici}. L'argument « l'EHCVM permettra le suivi » suppose cette vague ; il est à confirmer
auprès de l'INS avant d'être avancé devant une instance de décision.
\end{attention}
...
\begin{enumerate}
  ...
  \item \textbf{Le décompte des cibles favorise la source la mieux dotée en indicateurs}, et
        compte plusieurs fois un même indicateur quand plusieurs cibles s'y rapportent. L'écart réel
        entre les deux sources porte sur trois indicateurs distincts, dont deux de santé.
