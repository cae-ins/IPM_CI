...
par l'échelle FIES de la FAO, puis celui du renoncement aux soins pour raison de coût --- et en
...
\emph{pas} consulté (3.05) et a cité le \textbf{coût} comme raison principale (3.06, modalités
« trop cher » et « manque d'argent »).
...
empêché par l'argent}. C'est un fait, pas un droit théorique : le ménage a été malade, et n'a pas
pu se soigner. L'indicateur prive \textbf{9,2~\% des ménages} (8,9~\% de la population). Il ne
peut être privé que parmi les 67,2~\% de ménages ayant connu un problème de santé sur la période :
un ménage où personne n'a été malade n'est pas privé.
