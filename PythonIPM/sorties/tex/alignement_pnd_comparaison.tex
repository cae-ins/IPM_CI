...
\textbf{L'IPM EHCVM est le plus aligné sur le \emph{contenu} des cibles du PND}, pour une raison
qui tient en une ligne : le recensement ne pose aucune question de santé. L'assurance maladie et le
renoncement aux soins lui échappent entièrement, et avec eux les cibles santé du Pilier 4. Il porte
en outre la consommation, donc la pauvreté monétaire. Si un seul indice devait tenir le cadre de
résultats, c'est celui-là.
...
Indirecte & 3 & 2 \\
Partielle & 2 & 0 \\
Opérationnelle (ciblage) & 0 & 3 \\
Aucune & 6 & 8 \\
\bottomrule
\end{tabular}
\end{center}

\begin{attention}[Ce tableau flatte l'EHCVM, et il faut savoir pourquoi]
Il compte des \emph{cibles}, or plusieurs cibles retombent sur le \emph{même} indicateur : les deux
cibles d'analphabétisme sur l'indicateur d'alphabétisation, les deux cibles de couverture sociale
sur l'indicateur d'assurance maladie. En \textbf{indicateurs distincts} à prise directe, le compte
passe de 11 contre 7 à \textbf{9 contre 6}.

Il récompense en outre mécaniquement la source la mieux dotée : l'EHCVM porte seize indicateurs, le
RGPH treize. Ce n'est pas un résultat, c'est une propriété du questionnaire.

\textbf{L'écart réel se ramène à trois indicateurs} : l'assurance maladie, le renoncement aux soins,
et l'année de scolarité mesurée exactement plutôt qu'approchée par le diplôme. Deux sur trois sont
des indicateurs de santé --- c'est là, et seulement là, que se joue l'avantage de l'enquête.
\end{attention}
...
Désagrégation par sexe du chef de ménage (P.~4) & \textbf{oui} & non\textsuperscript{*} \\
...
\noindent\textsuperscript{*}\small{Le sexe est absent de l'\emph{extrait} RGPH transmis, non du
recensement : la numérotation des questions y passe de P16 à P18, la question P17 manquant. Une
demande à l'INS lèverait cette limite. Et dans les deux sources, désagréger par sexe du chef de
ménage éclaire la cible « indice de l'écart genre » sans la mesurer --- c'est un indice composite
couvrant l'emploi, l'éducation, la santé et la représentation politique.}

\begin{retenir}[Lecture]
L'EHCVM gagne sur le \textbf{contenu} du Pilier 4 : les cibles santé et nutrition, que le
recensement ne peut pas approcher parce qu'il ne pose aucune question de santé.
...
valeur de départ, très détaillée, mais aucune évolution. \textbf{Ce point est certain.}

L'EHCVM est une enquête répétée --- 2018, puis 2021. Le rythme passé laisse attendre une vague dans
l'intervalle du plan, mais \textbf{aucune programmation n'a été vérifiée ici} : l'argument « seule
l'EHCVM permettra le suivi » suppose cette vague et doit être confirmé auprès de l'INS avant d'être
avancé devant une instance de décision.
\end{attention}
...
\begin{enumerate}
  \item \textbf{Il couvre le cœur du Pilier 4}, le pilier du capital humain, où se concentrent les
        cibles sociales du plan. Les cibles santé et nutrition --- CMU, protection sociale, accès
        aux soins --- sont hors de portée du recensement, qui ne pose aucune question de santé.
        \textbf{C'est l'argument principal, et le seul qui soit hors de discussion.}
  \item \textbf{Il porte la consommation}, donc permet de croiser pauvreté monétaire et
        multidimensionnelle --- ce que l'objectif général du plan appelle, et que le recensement ne
        permet pas.
  \item \textbf{Il est actualisable en principe}, étant une enquête répétée, là où le recensement
        décennal ne le sera pas avant 2031. Le calendrier précis de la prochaine vague reste à
        confirmer.
\end{enumerate}

\noindent Un quatrième argument est souvent avancé --- « il couvre onze cibles contre sept » ---
mais il ne résiste pas à l'examen : ramené aux indicateurs distincts, l'écart est de neuf contre
six, et il se réduit aux trois indicateurs cités plus haut.
...
\begin{enumerate}
  \item \textbf{Le décompte des cibles est un jugement, pas une mesure}, et il est biaisé en faveur
        de la source la mieux dotée en indicateurs. Classer une prise en « directe », « approchée »
        ou « indirecte » suppose d'apprécier la proximité entre un indicateur de ménage et une cible
        souvent formulée en taux individuel. C'est pourquoi la conclusion de ce document ne repose
        pas sur ce décompte mais sur l'absence de module de santé au recensement, qui est un fait.
