...
Huit feuilles. Les six feuilles de désagrégation et la feuille \textsf{Ensemble} ont exactement
...
\textbf{Lecture.} $H = 0{,}5795$ pour l'ensemble : \textbf{58,0~\% de la population ivoirienne},
...
\begin{description}
  ...
  [0,5489 ; 0,6101] autour de $H = 0{,}5795$. Lecture : « l'incidence est comprise entre 54,9 et
  61,0~\% ».

  \item[\col{A\_ic\_bas}, \col{A\_ic\_haut}] Les bornes de l'intervalle de $A$. Elles sont
  toujours serrées ([0,4894 ; 0,4985] pour l'ensemble) : l'intensité est une moyenne sur les
  pauvres, une population nombreuse et homogène.

  \item[\col{M0\_ic\_bas}, \col{M0\_ic\_haut}] Les bornes de l'intervalle de \ipm{} :
  [0,2700 ; 0,3026]. Ce sont ces deux colonnes qui doivent accompagner tout \ipm{} publié.
  ...
  concernée ; 15 départements sur 108 et 93 sous-préfectures sur 442 le sont.
\end{description}
...
Une ligne par indicateur, seize lignes. Elle répond à une question différente des précédentes :
